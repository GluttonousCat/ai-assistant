...
from core.agent.intent import LayeredIntentClassifier, get_intent_classifier
from skills.base import SkillContext
from skills.fin_query.skill import FinQuerySkill
from skills.report.skill import ReportSkill
from skills.beta_alpha.skills.beta import BetaSkill
...
def invoke_financial_agent(user_input: str, session_id: Optional[str] = None) -> AgentState:
    ...
    from core.workflow.graph import invoke_agent
    from core.agent.context_store import get_session_stocks, update_session_from_result
