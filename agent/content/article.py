...
from agent.content.prompts import (DISCLAIMER, GZH_STOCK_ARTICLE_PROMPT,
...
def _render_charts(profile: Dict) -> Dict[str, str]:
    ...
    from agent.content import charts
...
def write_stock_article(stock: str, years: int = 5,
    ...
    if use_annual:
        try:
            from agent.content.annual_report import annual_digest
